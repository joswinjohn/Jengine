...
// vec3 class by NASA, changed into a struct, using float instead of double
// https://healpix.jpl.nasa.gov/html/cxxsupport/vec3_8h-source.html
...
struct mesh {
	std::vector<triangle> cube_points;
};